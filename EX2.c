...
int main(){
    ...
    unsigned int num_input = 1000;
    unsigned int num_comparison = 1000;
    int num_1 = 0;
    int num_2 = 0;
    int calculation [7] = { 
    (num_1 = num_input / 100) / 10, 
    (num_1 = num_input / 100) % 10,
    (num_1 = num_input % 100) / 10, 
    (num_1 = num_input % 100) % 10, 
    num_1 = num_input / 100,
    ...
    if (num_input >= 1000 && num_input <= 9999 && num_comparison >= 1000 && num_input <= 9999 ) {
        ...
        for (int count = 0; count != 4; count++ ) {
            ...
            printf("%d\n", calculation[count]);
            if ( num_2 == Analizer[0] / 10) {
                
            } if (num_2 == Analizer[0] % 10) {
                
            } if (num_2 == Analizer[1] / 10) {
